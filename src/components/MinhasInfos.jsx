        ...
        <div id="sobre-mim" className="mt-10 flex flex-col items-center w-full p-4 pl-1 lg:text-lg lg:w-[80%] lg:mt-14 lg:mx-auto">
            ...
            <span className="text-justify lg:text-justify m-5">
                ...
                <ul
                    ...
                    className='ml-7'
                >
                    <li>Frontend: React, React hooks, React Router, Redux, Context API e testes unitários com Jest e RTL.</li>
                    <li>Backend: Node.JS, Express, bibliotecas ORM (Sequelize) e ODM (Mongoose), MySQL e MongoDB, além de Python básico.</li>
